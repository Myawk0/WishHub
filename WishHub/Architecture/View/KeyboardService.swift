...
typealias KeyboardServiceCompletion = (_ keyboardBeginFrame: CGRect,
                                       _ keyboardEndFrame: CGRect,
                                       _ keyboardBounds: CGRect,
                                       _ safeInsets: UIEdgeInsets) -> Void
    ...
    private func checkHeight(bounds: CGRect) {
        ...
        if lastHeight != newHeight {
            ...
            DispatchQueue.main.async { [weak self] in
                ...
                self.onChangeHeightCallback?(newHeight)
            }
        }
    }
